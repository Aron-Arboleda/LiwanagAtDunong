    ...
    <StandardLayout>
      <MainContainer>
        <Section backgroundColor="#c0eba6" fullContentArea={true}>
          ...
          />
          <GridFoldersContainer withSpaceAbove={false}>
                ...
                <CardLargeContainer>
                  <FlexLayoutColumn>
                    <p className="pageParagP">
                      ...
                      goal of aiding community members in obtaining an
                    ...
                    <p className="pageParagP">
                      ...
                      focus: (1) Pagbasa sa Filipino; (2) Reading in English;
                      and (3) Basic numeracy. Currently, the program is
                      undergoing adjustments to align with the competencies
                      necessary for completing basic education.
                    </p>
                    <p className="pageParagP">
                      Delivery of the program is facilitated in partnership with
                      the Manila Public School Teachers Association (MPSTA).
                      MPSTA consistently deploys volunteer teachers every Sunday
                      to conduct classes for individuals at Beginning,
                      Developing, and Intermediate Levels. Individual volunteers
                      also sign up to provide personalized guidance for
                      beginning readers, engage in educational activities with
                      the children, and conduct research tasks.
                    </p>
                    <StandardChunkFiveTitle title="Program Wins" />
                    <p className="pageParagP">
                      Since its initiation in April 2023, the program has
                      successfully aided ten community members in achieving
                      their elementary and secondary education through the
                      Alternative Learning System (ALS).
                    </p>
                    <p className="pageParagP">
                      Currently, the program is expanding its efforts to train
                      Aeta teachers from the pool of ALS completers, enabling
